...
const StylistAccountSettings: React.FC<AccountSettingsProps> = ({ user, onLogout, subtitle }) => {
  ...
  return (
    <div className="p-4 flex flex-col h-full bg-gray-50 overflow-y-auto pb-48">
        <h1 className="text-3xl font-black tracking-tighter px-2 pt-2 mb-8" style={{ color: ensureAccessibleColor(branding.accentColor, '#F9FAFB', '#1E3A8A') }}>Stylist Account</h1>
...
export default StylistAccountSettings;
